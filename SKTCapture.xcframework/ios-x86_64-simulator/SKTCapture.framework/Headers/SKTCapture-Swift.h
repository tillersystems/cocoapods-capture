...
#ifndef SKTCAPTURE_SWIFT_H
#define SKTCAPTURE_SWIFT_H
...
#import <SKTCapture/SKTCapture.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SKTCapture",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SKTCapture13CaptureHelper")
...
///
- (void)didReceiveEvent:(SKTCaptureEvent * _Null_unspecified)event forCapture:(SKTCapture * _Null_unspecified)capture withResult:(SKTResult)result;
@end


/// Capture Helper device, represents a device that is attached to Capture
SWIFT_CLASS("_TtC10SKTCapture19CaptureHelperDevice")
...
SWIFT_CLASS("_TtC10SKTCapture26CaptureHelperDeviceManager")
